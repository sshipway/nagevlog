...
void engine_shutdown()
{
	...
	if(engine_last_event) {	free(engine_last_event); engine_last_event = NULL; }
}
 ...
 *----------------------------------------------------------------------------*/
int engine_process_event(ntsl_event *eventp)
{
	int	rc  = -1;
	...
	if (eventp)	{
		...
		event_output(eventp);
//		if(engine_last_event) {free(engine_last_event);}
//		engine_last_event = eventp;			
