...
#define COPYRIGHT   			"(C) S.Shipway 2004-6, built on GPL code (C) Sabernet.net 2002 and (C) Ethan Galstead"
...
#define NTSL_BIAS               300000  /* milliseconds to sleep between scans      */ 
