...
#define NTSL_ERROR_SOCKET_INIT \
			"Failed to open NSCA socket. error: %d"

#define NTSL_ERROR_SOCKET_SEND \
			"Failed to send data to NSCA host. error: %d"
...
#define NTSL_ERROR_SYSLOG_THREAD \
			"Failed to start Nagios EventLog service."
...
#define NTSL_ERROR_SYSLOG_CONFIG \
			"No valid NSCA host has been configured!"
...
#define NTSL_ERROR_SYSLOG_HOST \
			"Received message from unauthorized host: %s"
