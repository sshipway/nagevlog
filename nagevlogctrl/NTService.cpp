...
BOOL CNTService::Install()
{
	...
	if (!service.Create(manager, m_sServiceName, m_sDisplayName, 0,
						...
						SERVICE_ERROR_NORMAL, szAppPath, NULL, 
						NULL, NULL, NULL, NULL))
	{
	...
	csMessage.Format( _T("Service %s was succesfully installed.\n"), m_sServiceName);
...
BOOL CEventLogRecord::GetEventMessage(const EVENTLOGRECORD *pRecord)
{
	...
	_stprintf( szBuffer, _T( "SYSTEM\\CurrentControlSet\\Services\\EventLog\\%s\\%s"), m_sLogType,
					 m_sSourceName);
